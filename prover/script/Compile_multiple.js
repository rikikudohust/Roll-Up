...
function CompileCircuit()
{
    ...
    execute('snarkjs zkey export verificationkey ../proof/multiple_tokens_transfer_and_withdraw_final.zkey ../proof/multiple_key.json')
...
function generateProof()
{
    ...
    execute('snarkjs groth16 verify ../proof/multiple_key.json ../proof/public.json ../proof/proof.json')
}
